  ...
  return (
    <div className="pointer-events-none fixed bottom-4 right-4 z-[70] max-w-[calc(100vw-2rem)]">
      <Link
        ...
        className="pointer-events-auto group block rounded-[1.4rem] p-[2px] shadow-2xl shadow-blue-900/15 transition-transform hover:-translate-y-0.5 focus-visible:outline-none focus-visible:ring-0"
      >
        <span className="ai-agent-border-flow block rounded-[1.3rem] p-[2px]">
          <span className="flex items-center gap-3 rounded-[1.15rem] border border-white bg-white px-4 py-3 text-udaan-navy shadow-[0_12px_30px_rgba(0,103,185,0.12)] transition-all group-hover:shadow-[0_16px_36px_rgba(0,103,185,0.18)] sm:px-5 sm:py-3.5">
            ...
            <span className="min-w-0 text-left">
              ...
              <span className="mt-1 block max-w-[220px] truncate text-xs text-slate-600">
