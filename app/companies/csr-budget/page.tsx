...
import { PieChart, TrendingUp, IndianRupee, Plus, Trash2 } from "lucide-react"
...
export default function CSRBudgetPage() {
  ...
  const formatINRNumber = (amount: number) =>
    new Intl.NumberFormat("en-IN", {
      maximumFractionDigits: 0,
    }).format(amount)
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex items-center gap-2">
              <IndianRupee className="h-5 w-5 text-udaan-orange" />
              <span className="text-3xl font-bold text-udaan-navy">{formatINRNumber(totalBudget)}</span>
            </div>
          </CardContent>
        </Card>
        <Card>
